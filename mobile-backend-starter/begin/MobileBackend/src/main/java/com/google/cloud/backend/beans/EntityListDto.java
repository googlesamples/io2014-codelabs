...
public class EntityListDto {
   ...
   * 
   * @return {@link java.util.List} of Ids.
   */
  ...
  /**
   * Returns a List of {@link com.google.appengine.api.datastore.Key}s for all {@link EntityDto}s.
   * 
   * @return List of {@link com.google.appengine.api.datastore.Key}s for all {@link EntityDto}s.
   */
