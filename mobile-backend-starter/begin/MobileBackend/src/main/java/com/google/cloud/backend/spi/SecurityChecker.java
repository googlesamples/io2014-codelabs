...
public class SecurityChecker {
  ...
  /**
   * Sets default security properties on the specified {@link com.google.cloud.backend.beans.EntityDto}.
   *
   * @param cd
   *          {@link com.google.cloud.backend.beans.EntityDto}
   * @param user
   *          {@link com.google.appengine.api.users.User} of the creator of CloudEntity
   */
